      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center space-x-3">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary-800 to-primary-900 flex items-center justify-center shadow-lg">
              <Shield className="w-7 h-7 text-white" />
            </div>
            <div className="hidden sm:block">
              <span className="font-bold text-xl text-gray-900">Chatman</span>
              <span className="font-light text-xl text-primary-700"> Insurance</span>
            </div>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="text-gray-600 font-medium hover:text-primary-700 transition-colors"
              >
                {link.name}
              </a>
            ))}
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center space-x-1 text-gray-600 font-medium hover:text-primary-700 transition-colors"
              >
                <span>Demo</span>
                ...
                <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Manage policies & leads</p>
                    </div>
                  </Link>
                  <Link
                    href="/demo/user"
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <a
              href="#quote"
              className="px-6 py-2.5 bg-gradient-to-r from-primary-800 to-primary-900 text-white rounded-lg font-medium hover:shadow-lg hover:shadow-primary-900/25 transition-all"
            >
              Get a Quote
            </a>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-white rounded-2xl shadow-xl mt-2 p-6 absolute left-4 right-4 border border-gray-100">
            <div className="flex flex-col space-y-4">
              ...
              <a
                href="#quote"
                className="flex items-center justify-center px-6 py-3 bg-gradient-to-r from-primary-800 to-primary-900 text-white rounded-lg font-medium"
              >
                Get a Quote
              </a>
            </div>
