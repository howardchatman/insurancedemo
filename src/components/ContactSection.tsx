...
import { Phone, Mail, MapPin, Clock, Send, Check, Shield } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8">
              Ready to get protected or have questions about your coverage? Our team of licensed advisors is here to help 24/7.
            </p>
            ...
            <div className="space-y-6 mb-8">
              ...
              <a
                ...
                className="flex items-start space-x-4 p-4 bg-gray-50 rounded-xl hover:bg-primary-50 transition-colors group"
              >
                ...
                <div>
                  ...
                  <p className="text-primary-700 font-medium">hello@chatmaninsurance.com</p>
              ...
              <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-600">123 Insurance Plaza, Suite 500</p>
                  <p className="text-gray-500 text-sm">Houston, TX 77002</p>
                </div>
              </div>
              ...
              {isSubmitted ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">
                    A licensed advisor will contact you shortly to discuss your coverage needs.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-primary-800 to-primary-900 text-white rounded-xl font-semibold text-lg flex items-center justify-center space-x-2 hover:shadow-lg hover:shadow-primary-900/25 transition-all disabled:opacity-70"
                  >
                    {isSubmitting ? (
                      <>
